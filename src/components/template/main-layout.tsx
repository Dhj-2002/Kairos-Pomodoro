  ...
  return (
    <div className="flex h-screen bg-sahara-bg text-sahara-text font-sans overflow-hidden">
      ...
      >
        ...
        <div className={cn(
          "flex-1 min-h-0 scroll-smooth pb-20 md:pb-0",
        ...
        <AnimatePresence initial={false}>
          {/* Opacity-only: a y/scale transform here would establish a
              containing block and break MobileNav's `position: fixed`. */}
          {!isFullscreenFocus && (
            <m.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
