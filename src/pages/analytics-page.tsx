...
import { exportAnalyticsCsv } from "@/lib/export-csv";
        ...
        <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8 md:mb-12">
          ...
          <div className="flex gap-2 md:gap-4 self-start sm:self-auto">
            <Button
              ...
              className="gap-1.5 px-4 text-[10px] font-bold uppercase tracking-widest"
              title="Export category hours as CSV"
            >
              {exportingCsv ? <Loader2 className="size-3.5 animate-spin" /> : <FileDown className="size-3.5" />}
