            ...
            <div className="max-w-2xl lg:max-w-3xl xl:max-w-4xl space-y-8 md:space-y-10">
              ...
              {activeTab === "notifications" && (
                <SettingsNotifications
                  ...
                  scheduleReminderSound={settings.scheduleReminderSound}
                  onScheduleReminderSoundChange={(sound) =>
                    updateSetting("scheduleReminderSound", sound)
                  }
                  scheduleReminderVolume={settings.scheduleReminderVolume}
                  onScheduleReminderVolumeChange={(volume) =>
                    updateSetting("scheduleReminderVolume", volume)
                  }
                />
              )}
